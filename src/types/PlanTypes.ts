export interface Feature {
  ...
  export const plans: Plan[] = [
    ...
    },
    {
      ...
      priceUnit: '',
      features: [
        { text: 'Avaliação pós-serviço', included: true },
        { text: 'Comentários detalhados', included: true },
        { text: 'Fotos do resultado', included: true },
        { text: 'Classificação por estrelas', included: true },
        { text: 'Feedback para melhorias', included: true },
        { text: 'Recomendações para outros', included: true },
        { text: 'Histórico de avaliações', included: true },
        { text: 'Impacto na comunidade', included: true },
        { text: 'Recompensas por avaliação', included: false },
        { text: 'Avaliações verificadas', included: false },
        { text: 'Programa de influenciadores', included: false },
      ],
    },
  ];